...
public static class ConversationIntentTools
{
    ...
    [
        ...
        new(IntentNames.GetTeamThisMonth, "A manager asks for their team's standing this month.", NoParameters),
        new(IntentNames.GetTeamHistory, "A manager asks for their team's monthly history.",
            """{"type":"object","properties":{"months":{"type":"string","description":"How many months back; defaults to 6 when omitted."}},"required":[]}"""),
        new(IntentNames.GetAtRisk, "A manager asks who on their team is at risk of missing the goal.", NoParameters),
